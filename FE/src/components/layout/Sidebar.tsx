...
import { LayoutDashboard, Users, BookOpen, FileText, BarChart2, MessageSquare, ListChecks, TestTube } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen }) => {
  const navItems = [
    ...
    { to: '/practices', icon: <ListChecks className="w-5 h-5" />, label: 'Bài luyện tập' },
    { to: '/exercises', icon: <BarChart2 className="w-5 h-5" />, label: 'Bài tập bắt buộc' },
    { to: '/tests', icon: <TestTube className="w-5 h-5" />, label: 'Bài kiểm tra' },
